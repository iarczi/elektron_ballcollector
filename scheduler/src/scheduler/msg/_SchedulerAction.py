"""autogenerated by genpy from scheduler/SchedulerAction.msg. Do not edit."""
import sys
...
class SchedulerAction(genpy.Message):
  _md5sum = "649e5cd3d0369bfd72c1f24aed2b51ea"
  _type = "scheduler/SchedulerAction"
...
"""
  ...
  _slot_types = ['scheduler/SchedulerActionGoal','scheduler/SchedulerActionResult','scheduler/SchedulerActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SchedulerAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = scheduler.msg.SchedulerActionGoal()
      if self.action_result is None:
        self.action_result = scheduler.msg.SchedulerActionResult()
      if self.action_feedback is None:
        self.action_feedback = scheduler.msg.SchedulerActionFeedback()
    else:
      self.action_goal = scheduler.msg.SchedulerActionGoal()
      self.action_result = scheduler.msg.SchedulerActionResult()
      self.action_feedback = scheduler.msg.SchedulerActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.value, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.value, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.value,) = _struct_i.unpack(str[start:end])
      return self
